...
class GUI(QWidget):
    ...
    def __init__(self):
        ...
        self.error1 = EMA(c = 0.9)
        self.error2 = EMA(c = 0.9)
        self.volume = EMA(c = 0.9)
    ...
    def paintEvent(self, event):
        ...
        paint_scale(scale_1_height)
        paint_scale(scale_2_heigth)
        ...
        painter.setFont(QFont("Helvetica", font_size))
        painter.drawText(self.width() // 2 - font_size // 2 - 20, 
                         scale_1_height - 70, 
                         top_note)
        painter.drawText(self.width() // 2 - font_size // 2 - 20, 
                         scale_2_heigth - 70, 
    ...
    def handle_frequency_detected(self, input):
        ...
        if input.freqs[0] != 0 or input.freqs[1] != 0:
            ...
            self.notes = [config.notes_to_track[n] if n != -1 else '' for n in notes]
